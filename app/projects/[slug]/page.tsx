...
export default async function ProjectPage({params}:{params:Promise<{slug:string}>}){
  ...
  return <><SiteHeader/><main><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(schema)}}/>
    ...
    <section className="project-outcome"><div className="section-shell"><span className="eyebrow light">What this demonstrates</span><h2>{p.outcome}</h2><Link className="button button-primary" href="/contact" data-track="case_study_cta" data-cta-id="project_enquiry" data-placement="project_outcome">Discuss a similar requirement <ArrowRight size={18}/></Link></div></section>
  </main><SiteFooter/></>;
}
